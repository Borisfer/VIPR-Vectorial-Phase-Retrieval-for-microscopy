...
IS.last_iter = 200; % how many iterations  to run not with SGD (at end of optimization)
IS.last_iter_flag = 2; % 1 - contuine SGD, 2 - global gradient, 3- batch the lowest correlation points, 4- adaptive sampling with side info on corr
